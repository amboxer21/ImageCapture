...
```javascript
cmake -DWITH_EIGEN=TRUE -DWITH_FFMPEG=TRUE -DWITH_GSTREAMER=TRUE -DWITH_GTK=TRUE -DWITH_JPEG=TRUE -DWITH_OPENGL=TRUE -DWITH_PNG=TRUE -DWITH_V4L=TRUE -DWITH_VA=TRUE -DWITH_GPHOTO2=TRUE CMAKE_INSTALL_PREFIX=/usr/local/bin/ ..
```
